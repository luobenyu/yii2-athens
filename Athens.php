...
namespace lubaogui\athens;

use Yii;
use yii\web\AssetBundle;
use yii\base\InvalidConfigException;
use lubaogui\athens\bundles\ThemeAsset;

/**
 * This is the class of Athens Component
 */
class Athens extends \yii\base\Component {
     ...
     * Classes paths
     */
    const CLASS_HTML = '@vendor/lubaogui/yii2-athens/helpers/Html.php';
     ...
     */
    public static $componentName = 'athens';
    ...
    public function init()
    {
        ...
        {
            throw new InvalidConfigException('Default Yii2 Html helper class is not allowed. For using Athens theme put Yii::$classMap[\'yii\\helpers\\Html\'] = \'' . self::CLASS_HTML . '\'; into your bootstrap.php');
        }
    ...
    /**
     * @return Athens Get Athens component
     */
